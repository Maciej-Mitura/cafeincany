...
const menuItems: MenuItem[] = [
  {
    name: "Stella / Jupiler",
    description: "Jij houdt toch ook van een koude pint?",
    price: "€2.50",
    tags: [{ label: "Van 't vat of in fles", color: "accent" }],
  },
  {
    name: "Apero bordje 'Deluxe' ",
    description: "Beter dan dit, vind je niet!",
    price: "€15.00",
    tags: [
      { label: "Salami", color: "accent" },
      { label: "Kaas", color: "accent" },
      { label: "Olijven", color: "accent" },
      { label: "Pharmaham", color: "accent" },
      { label: "Witte pens", color: "accent" },
      { label: "Pate", color: "accent" },
      { label: "Tapenade", color: "accent" },
      { label: "Dipsticks", color: "accent" },
    ],
  },
  {
    name: "Verwenkoffie",
    description: "Laat je verwennen met een kopje koffie en een lekker dessert",
    price: "€7.50",
    tags: [
      { label: "Koffie", color: "accent" },
      { label: "Dessert", color: "accent" },
    ],
    //isNew: true,
  },
  {
    name: "Apero 'In Cany - Sunset Layer'",
    description: "Huisgemaakte apero met verschillende kleuren en smaken",
    price: "€9.00",
    tags: [
      { label: "Huisgemaakt", color: "accent" },
      { label: "Apero", color: "accent" },
    ],
  },
  {
    name: "Tomato Mozarella",
    description: "Verse tomaten, mozarella met rucola en wat pijnboompitten ",
    price: "€8.00",
    tags: [{ label: "Salade", color: "accent" }],
    isNew: true,
  },
  {
    name: "Stuk pizza - prosciutto",
    description: "Heerlijke pizza met prosciutto",
    price: "€6.00",
    tags: [{ label: "Pizza", color: "accent" }],
  },
];
